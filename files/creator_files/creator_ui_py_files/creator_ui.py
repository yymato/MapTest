...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.load_test_button = QtWidgets.QPushButton(parent=self.centralwidget)
        self.load_test_button.setGeometry(QtCore.QRect(1040, 10, 121, 31))
        ...
        self.choose_variant_question_button = QtWidgets.QPushButton(parent=self.centralwidget)
        self.choose_variant_question_button.setGeometry(QtCore.QRect(300, 10, 121, 31))
        self.choose_variant_question_button.setObjectName("choose_variant_question_button")
